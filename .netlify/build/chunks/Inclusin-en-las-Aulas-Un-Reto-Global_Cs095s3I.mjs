const id = "Inclusin-en-las-Aulas-Un-Reto-Global.md";
						const collection = "blog";
						const slug = "inclusin-en-las-aulas-un-reto-global";
						...
						const data = {title:"Inclusión en las Aulas: Un Reto Mundial",description:"El desafío de integrar a estudiantes de todas las capacidades en el sistema educativo moderno.",posted:new Date(1726110000000),heroImage:"/pexels-rdne-5756661.jpg"};
						const _internal = {
							type: 'content',
							filePath: "C:/blog-template/src/content/blog/Inclusin-en-las-Aulas-Un-Reto-Global.md",
							rawData: undefined,
						};
